<x-layouts.admin title="Dashboard PAC">
    <div class="max-w-5xl mx-auto mt-10 bg-white p-6 rounded-lg shadow" x-data="tabelArtikel()">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('pac.artikel.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">
                + Tambah Artikel
            </a>
        </div>
        ...
        <div x-ref="tempatTabel" @click="tanganiPaginasi($event)">
            @include('pac.artikel.partials.table', ['artikels' => $artikels])
        </div>
