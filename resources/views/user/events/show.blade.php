<x-layouts.app title="{{ $event->title }}">
    @push('meta')
        ...
        <meta property="og:description" content="{{ Str::limit(strip_tags($event->description), 120) }}">
        <meta property="og:image" content="{{ asset('storage/' . $event->thumbnail) }}">
        ...
        <div class="max-w-6xl mx-auto">
                    ...
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-center shadow-2xl">
                        ...
                        <div class="flex justify-center items-center gap-1.5 sm:gap-4 text-center">
                            ...
                            <div class="flex flex-col items-center">
                                <div class="bg-white text-blue-900 rounded-xl sm:rounded-2xl w-12 h-12 sm:w-20 sm:h-20 flex items-center justify-center text-xl sm:text-4xl font-black shadow-lg">
                            ...
                            <!-- Detik -->
                            <div class="flex flex-col items-center">
                                <div class="bg-blue-500 text-white rounded-xl sm:rounded-2xl w-12 h-12 sm:w-20 sm:h-20 flex items-center justify-center text-xl sm:text-4xl font-black shadow-lg">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl sm:rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-colors">
                <div class="p-5 sm:p-10 lg:p-12">
                    ...
                    <!-- TOMBOL SHARE / BERBAGI ACARA -->
                    <div class="flex flex-wrap items-center gap-3 mb-8 pt-6 border-t border-gray-100 dark:border-gray-700" x-data="{ copied: false }">
                        <span class="text-sm font-bold text-gray-700 dark:text-gray-300">Bagikan Acara Ini:</span>
                        
                        <!-- Share WhatsApp -->
                        <a href="https://wa.me/?text={{ urlencode('Yuk ikuti kegiatan *' . $event->title . '* di Pelajar Nuju! Daftar selengkapnya di: ' . request()->url()) }}" target="_blank" class="inline-flex items-center px-4 py-2 rounded-xl text-xs font-bold text-white bg-green-600 hover:bg-green-700 transition shadow-sm">
                        ...
                        <!-- Salin Tautan -->
                        <button @click="navigator.clipboard.writeText(window.location.href); copied = true; setTimeout(() => copied = false, 2000)" class="inline-flex items-center px-4 py-2 rounded-xl text-xs font-bold text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition shadow-sm">
