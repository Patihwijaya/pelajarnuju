...
<div class="">
    <h3 class="font-bold text-xl">Detail Pengajuan SK IPPNU</h3>
@if ($pengajuan->isNotEmpty())
    ...
    <div class="p-5 rounded-lg border-2 border-gray-300 mt-5">
            ...
            <div class="flex gap-3 text-white my-5">
                ...
                <form action="{{ route('admin.pengajuanSkIppnu.updateStatus', $item->id) }}" method="POST">
                    @csrf
                ...
                @endif
                <form action="{{ route('admin.pengajuanSkIppnu.destroy', $item->id) }}" method="POST" class="inline-block"
