...
<div class="max-w-3xl mx-auto mt-10 bg-white p-6 rounded-lg shadow">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Tambah Pengurus Baru</h1>
    ...
    <form action="{{ route('admin.strukturIppnu.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
