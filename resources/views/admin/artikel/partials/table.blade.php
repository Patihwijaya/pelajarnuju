            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="p-3 border text-center">
                    <div class="flex items-center justify-center gap-1.5 flex-wrap">
                        ...
                        <a href="{{ route('admin.artikel.show', $artikel->id) }}" class="bg-gray-600 text-white px-2.5 py-1 rounded text-xs hover:bg-gray-700">Lihat</a>

                        <!-- Tombol Edit -->
                        <a href="{{ route('admin.artikel.edit', $artikel->id) }}" class="bg-blue-600 text-white px-2.5 py-1 rounded text-xs hover:bg-blue-700">Edit</a>
