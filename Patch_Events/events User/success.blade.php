        ...
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700 p-8 sm:p-10 text-center transition-colors">
                ...
                <div class="mt-6 inline-flex flex-col items-center justify-center bg-blue-50 dark:bg-gray-700/60 border border-blue-200 dark:border-gray-600 rounded-2xl p-6 w-full max-w-md mx-auto shadow-sm">
                    ...
                    <span class="text-3xl font-mono font-black text-gray-900 dark:text-white tracking-widest select-all my-2">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700 p-8 sm:p-10 transition-colors">
                ...
                <div id="registration-card" class="bg-gradient-to-br from-blue-950 via-indigo-950 to-slate-900 text-white px-8 pt-8 pb-10 rounded-3xl shadow-2xl border border-blue-500/30 relative max-w-md mx-auto">
                    ...
                    <div class="bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/10 flex items-center justify-between gap-4 mb-6 relative z-10">
                        <div class="flex-1">
                            <div class="mb-3">
                                <p class="text-[9px] uppercase tracking-wider text-blue-200 font-medium mb-1">Nama Lengkap:</p>
                                <!-- leading-relaxed dan pb-1 mencegah huruf bawah terpotong -->
                                <p class="text-sm uppercase sm:text-base font-black text-white leading-relaxed pb-1 truncate">
                                    {{ $registration->answers['nama_lengkap'] ?? 'Peserta' }}
                                </p>
                            </div>
                        </div>
                        <!-- QR Code Check-in -->
                        <div class="bg-white p-2 rounded-xl shadow-md shrink-0">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data={{ urlencode(route('checkin.form', $event->slug)) }}" alt="QR Checkin" class="w-16 h-16 sm:w-20 sm:h-20">
                        </div>
                    </div>

                    <!-- 4. ID Pendaftar Unik & Tanggal -->
                    <div class="flex justify-between items-end mb-6 text-xs relative z-10">
                        <div>
                        ...
                        <div class="text-right">
                            ...
                            <span class="font-bold text-white">{{ $registration->created_at->format('d F Y') }}</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Add to Calendar -->
                <a href="{{ $gcalUrl }}" target="_blank" class="flex items-center p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm hover:shadow-md transition group">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Atur pengingat otomatis di HP Anda</p>
                    </div>
                </a>
